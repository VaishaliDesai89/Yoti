...
public class TestHelper {
	...
	public WebElement getElementAfterAppearsByCss(final String selector, final long timeoutInseconds )
	{
		waitForPageLoad();
		new WebDriverWait(driver, timeoutInseconds).until(ExpectedConditions.elementToBeClickable(By.cssSelector(selector)));
	...
	public WebElement getElementAfterAppearsByCss(final String selector )
	{
		return this.getElementAfterAppearsByCss(selector, DEFAULT_ELEMENT_TIMEOUT);
	}
